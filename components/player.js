  ...
  render() {
    return (
      <div className="player">
        <div id="info" className={`info ${this.state.playing ? 'active' : ''}`}>
        ...
        <div id="control-panel" className={`control-panel ${this.state.playing ? 'active' : ''}`}>
          <div className="album-art"></div>
          <div className="controls">
            <div className="prev"></div>
            <div onClick={this.togglePlay.bind(this)} className="play"></div>
        ...
        <style jsx>{
          ...
          .player .control-panel .album-art::before {
            ...
            background-image: url("https://picsum.photos/400/400/?random");
          }
